  ...
  return (
    <div>
      ...
      <Box
        sx={{
          backgroundImage:
            'url("https://eng.kmutt.ac.th/wp-content/uploads/2017/10/banner-2.jpg")',
                  ...
                  <CardContent>
                    ...
                    >
                      ...
                      <Typography variant="body2">
                        Articles for guide you through the workshop and the
                        knowledge base that you can read along
                      </Typography>
              ...
              <CardActionArea>
                <CardContent>
                  ...
                  >
                    ...
                    <Typography variant="body2">
                      Event engagement and collaboration platform for bringing
                      all attendees closer to the community
                    </Typography>
                    {/* <Typography variant="body2">date</Typography> */}
                  </Box>
                </CardContent>
              ...
              <CardActionArea>
                <CardContent>
                  ...
                  >
                    ...
                    <Typography variant="body2">
                      Activity submission platform for claiming event reward
                      from finished task
                    </Typography>
                    {/* <Typography variant="body2">date</Typography> */}
                  </Box>
        ...
        <Container sx={{ height: "100%" }}>
          ...
          >
            <Typography color="black" fontSize="1rem">
              © 2022-2023 Google Developer Students Club, King Mongkut’s
              University of Technology Thonburi Chapter
            </Typography>
          </Box>
        </Container>
      </Box>
