	...
	if (check) {
		return (
			<Box width={'100vw'} height={'100vh'} display={'flex'} justifyContent={'center'} alignItems={'center'}>
				<Player autoplay speed={1} loop src={loading} style={{ height: '300px', width: '300px' }}></Player>
			</Box>
		)
	}
		...
		>
			...
			>
				...
				<Stack
					...
					alignItems={'center'}
				>
					<Typography fontFamily="body2" fontWeight="600" mt="3.9rem" mb="1.5rem">
						{' '}
						To getting started...{' '}
					</Typography>
					...
					>
						...
						/>
						<Typography fontFamily="body2" fontWeight="600">
							{' '}
							Sign in with Google{' '}
						</Typography>
					</Box>
